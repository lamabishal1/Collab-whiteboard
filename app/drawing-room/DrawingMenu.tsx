...
type DrawingMenuProps = {
  ...
  setDrawingPen: React.Dispatch<React.SetStateAction<DrawingPen>>; // ✅ better typing
};
...
const DrawingMenu: React.FC<DrawingMenuProps> = ({
  ...
  const changeColor = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsEraserActive(false); // ✅ auto-disable eraser when picking a color
  };
